import { CAW_ACTION } from "src/types";
import { getCawPriceInUsd } from "./tokenPrice";

export const NFT_COST: { [key: number]: number } = {
    1: 1000000000000,
    2: 240000000000,
    3: 60000000000,
    4: 6000000000,
...
export const ACTION_COST: { [key: string]: number } = {
    FOLLOW_ACC: 30000,
    SEND_CAW: 5000,
    LIKECAW: 2000,
    RECAW: 4000,
...
export const NftCostAtMcap = (username: string | number, marketCap: number[]) => {
    ...
    const costAtMcap: { [key: number]: number } = {};
